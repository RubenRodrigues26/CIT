...
select faculty.faculty_name from faculty, qualified where faculty.faculty_id = qualified.faculty_id and course_id = 'ISM 3113';
select faculty.faculty_name from faculty, qualified where faculty.faculty_id = qualified.faculty_id and course_id = 'ISM 3113' and course_id != 'ISM 4930';
select count(student_id) as studentsEnrolled from section, registration where section.section_no = registration.section_no and section.course_id = 'ISM 3113' and section.semester = 'I-2008';
