...
select count(student_id) as studentCount from registration where semester='I-2008' and section_no='2714';
select student_name from student order by student_name;
select student_id from registration where semester='I-2008' group by student_id,section_no;
