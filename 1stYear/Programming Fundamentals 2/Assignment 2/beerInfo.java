...
public class beerInfo {
		...
		public static void mainMenu(Scanner keyboard)
		{
			...
			if(firstChoice == 1){
				...
				secondChoice = keyboard.next().toUpperCase().charAt(0);
					...
					{
						System.out.print("Please select option A/B/C:");
						secondChoice = keyboard.next().toUpperCase().charAt(0);
					}	
						if(secondChoice == 'A' ){
							maxToMinByStrength();
			...
			if(firstChoice == 3){
				...
				secondChoice = keyboard.next().toUpperCase().charAt(0);
					while( SearchMenuValidation(secondChoice) == false)
					{
						System.out.print("Please select option A/B/C:");
						secondChoice = keyboard.next().toUpperCase().charAt(0);
					}		
	...
	public static boolean SearchMenuValidation(char secondChoice){
		boolean logic = false;
		if ((secondChoice == 'A') || (secondChoice == 'B') ||(secondChoice == 'C') ||(secondChoice == 'D')){
			logic = true;
		}
		return logic; 
	}	
	...
	public static void searchFreeText(Scanner keyboard){
		...
		for(int i = 0; i < BEER_NAME.length; i++){
			...
			while(search.length() < 3){
				System.out.println("Insert a string of 3 or more characters to search.");
